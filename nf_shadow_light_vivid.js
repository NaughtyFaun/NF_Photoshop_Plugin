...
app.nf.ShadowLight.prototype.createLayers = function(hasVivid, isAfter)
{
    ...
    if (hasVivid) {
        ...
        vivid.move(lastCreatedLayer, ElementPlacement.PLACEBEFORE)
